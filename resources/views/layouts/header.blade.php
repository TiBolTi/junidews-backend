<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            <a class="navbar-brand" @if (!Auth::user()) href="http://www.juni-devs.php-f22.ru" @endif
                @if (Auth::user()) href="{{ url('/') }} @endif">
                JUNI-DEVS
            </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" aria-current="page"
                                    href="{{ route('airlines.index') }}">Airlines</a>
                                <a class="dropdown-item" aria-current="page"
                                ...
                                <a class="dropdown-item" aria-current="page" href="{{ route('services.index') }}">Service
                                    codes</a>
                            </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                @if (auth()->user()->can('read perms'))
                                    <a class="dropdown-item" aria-current="page"
                                        href="{{ route('perms.index') }}">Permissions</a>
                                @endif
                            </div>
                        </li>
