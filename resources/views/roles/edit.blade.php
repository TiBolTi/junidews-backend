            ...
            <div style="max-height: 105px;" class="d-flex flex-wrap flex-column">
                @foreach ($permissions as $permission)
                    <div class="form-check">
                        <input @if ($role->hasPermissionTo($permission->name)) checked @endif class="form-check-input" type="checkbox"
                            name="permissions[]" value="{{ $permission->id }}" id="permissions_{{ $permission->id }}">
