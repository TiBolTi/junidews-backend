                    ...
                    <td class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="dropdown dropstart">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="">
                                <li><a href="{{route('perms.show', $permission)}}" class="btn dropdown-item" tabindex="-1"
                                       role="button">
                                        <i class="fa-solid fa-eye"></i> Просмотр</a></li>
                                @if(auth()->user()->can('edit perms'))
                                <li>
                                    <a href="{{route('perms.edit', $permission)}}" class="btn dropdown-item" id="{{ $permission->id }}" tabindex="-1"
                                       role="button">
                                ...
                                @if(auth()->user()->can('delete perms'))
                                    ...
                                    <button class="btn dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteModal"
                                            data-table="perms" data-id="{{ $permission->id }}">
